...
import { Text, View, Image, FlatList, Dimensions, TouchableOpacity, Modal, ScrollView } from "react-native";
...
const data = [
                { source: LightVid1 }, { source: LightVid2 }, { source: LightVid3 },
                { source: LightVid4 }, { source: LightVid5 }, { source: LightVid6 },
                { source: LightVid7 }, { source: LightVid8 }, { source: LightVid9 },
                { source: LightVid10 }, { source: LightVid11 }, { source: LightVid12 },
             ];
...
renderItem = ({ item, index }) => {
    ...
    render() {
        return (
            ...
            >
            <ScrollView>
                <TouchableOpacity style={styles.iconRow} onPress={this.props.onBackPress}>
                    <Image
